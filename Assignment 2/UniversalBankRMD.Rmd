...
2. The choice of K that balances between overfitting and ignoring predictor information appears to be K = 20.


```{r}

# Create the KNN model with K = 20 and only training and test data
...
3. Confusion matrix of the KNN model using K = 20.

```{r}

# Run the KNN model on the customer profile with the K = 20 value
